  ...
  return (
    <div className="relative inline-block" ref={wrapRef}>
      ...
      {open ? (
        ...
        >
          <p className="text-[10px] uppercase tracking-widest text-black/35 mb-1">{panelTitle}</p>
          ...
          {kind === "mailto" ? (
            <>
              ...
              <p className="mt-2 text-[10px] text-black/30">Tap the address to open your mail app.</p>
            </>
          ) : null}
          ...
          {kind === "external" ? (
            <>
              ...
              <p className="mt-2 text-[10px] text-black/30">Tap the link to open in a new tab.</p>
            </>
          ) : null}
          ...
          {kind === "anchor" ? (
            <>
              ...
              <p className="mt-2 text-[10px] text-black/30">Scrolls to a section on this page.</p>
            </>
          ) : null}
        </div>
      ) : null}
